...
WebUI.setText(findTestObject('Object Repository/Page_Qlue Smart City  Register Free Trial/input_Email_email'), 'ganjar.sayog1@gmail.com')
...
WebUI.verifyElementPresent(findTestObject('Page_Qlue Smart City  Register Free Trial/span_Please enter Your name'), 0)
