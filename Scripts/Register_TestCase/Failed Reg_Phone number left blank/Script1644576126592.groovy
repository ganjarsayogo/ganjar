...
WebUI.setText(findTestObject('Object Repository/Page_Qlue Smart City  Register Free Trial/input_Email_email'), 'ganjarsayog9@gmail.com')
...
WebUI.setText(findTestObject('Object Repository/Page_Qlue Smart City  Register Free Trial/input_358_phone'), '')

WebUI.click(findTestObject('Object Repository/Page_Qlue Smart City  Register Free Trial/button_GET STARTED NOW'))

WebUI.verifyElementPresent(findTestObject('Page_Qlue Smart City  Register Free Trial/span_Please enter Your phone'), 0)
