...
WebUI.setText(findTestObject('Object Repository/Page_Qlue Smart City  Register Free Trial/input_Name_name'), 'GanjarGanjarGanjarGanjarGanjarGanjarGanjarGanjarGan')

WebUI.setText(findTestObject('Object Repository/Page_Qlue Smart City  Register Free Trial/input_Email_email'), 'ganjar.sayog4@gmail.com')
...
WebUI.verifyElementPresent(findTestObject('Page_Qlue Smart City  Register Free Trial/span_Character minimal 4 and maximal 50'), 
    0)
