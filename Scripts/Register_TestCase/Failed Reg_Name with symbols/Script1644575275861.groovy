...
WebUI.setText(findTestObject('Object Repository/Page_Qlue Smart City  Register Free Trial/input_Name_name'), '@@@@@')

WebUI.setText(findTestObject('Object Repository/Page_Qlue Smart City  Register Free Trial/input_Email_email'), 'ganjar.sayog2@gmail.com')
...
WebUI.verifyElementPresent(findTestObject('Page_Qlue Smart City  Register Free Trial/span_Name only allow alphanumeric characters'), 
    0)
