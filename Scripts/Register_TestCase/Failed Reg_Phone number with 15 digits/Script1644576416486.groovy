...
WebUI.setText(findTestObject('Object Repository/Page_Qlue Smart City  Register Free Trial/input_Email_email'), 'ganjarsayo11@gmail.com')
...
WebUI.setText(findTestObject('Object Repository/Page_Qlue Smart City  Register Free Trial/input_358_phone'), '813458134581345')

WebUI.click(findTestObject('Object Repository/Page_Qlue Smart City  Register Free Trial/button_GET STARTED NOW'))

WebUI.verifyElementPresent(findTestObject('Page_Qlue Smart City  Register Free Trial/span_Digit minimal 4 and maximal 14'), 
    0)
