...
WebUI.setText(findTestObject('Object Repository/Page_Qlue Smart City  Register Free Trial/input_Email_email'), 'ganjarsayog6@gmail.com')

WebUI.setText(findTestObject('Object Repository/Page_Qlue Smart City  Register Free Trial/input_Company_company'), '@@@@')
...
WebUI.verifyElementPresent(findTestObject('Page_Qlue Smart City  Register Free Trial/span_Company only allow alphanumeric characters'), 
    0)
